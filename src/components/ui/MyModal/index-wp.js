// /*eslint-disable*/
// import { animateCSS, isMobile } from "@/components/js/utils";
...
//             const targetAttr = modalOpener.getAttribute(
//                 this.config.openSelector
//             );
...
//                 this.close(modalActive, false).then(() =>
...
//             await animateCSS(modal, "closeNotification");
